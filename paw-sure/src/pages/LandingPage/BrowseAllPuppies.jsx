  ...
  return (
    <div className="my-12">
      ...
      <div className="bg-gray-200 py-8 flex justify-center items-center text-center">
        <h2 className="text-lg sm:text-2xl font-semibold flex items-center flex-wrap justify-center gap-2 max-w-3xl">
...
export default BrowseAllPuppies;
